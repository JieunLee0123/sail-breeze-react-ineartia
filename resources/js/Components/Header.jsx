        ...
        <nav class="bg-white border-gray-200 py-5 container px-4">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
              <a href="#" class="text-gray_01 bg-gray_05 font-semibold rounded-sm text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">로그인</a>
              <a href="#" class="text-gray_01 bg-yellow_01 font-semibold rounded-sm text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">회원가입</a>
              <button onClick={onClickMenuBtn} data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-sm lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
