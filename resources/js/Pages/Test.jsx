...
const Test = () => {
  return (
    <div>
      tailwind.config.js 에 screens, colors 추가 했어요 !
      화면 크기 조정해보시면 어떻게 작동하는 건지 감이 잡히실 거에요 !
      <div className="bg-sub_green sm:bg-yellow_00 lg:bg-blue_04 dark:bg-gray-800 shadow rounded mx-auto w-[300px]">
